...
#include "../../qt5-shadow-maps/sources/openglviewer.h"
...
const QMetaObject OpenGLViewer::staticMetaObject = {
    { &QOpenGLWidget::staticMetaObject, qt_meta_stringdata_OpenGLViewer.data,
      qt_meta_data_OpenGLViewer,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *OpenGLViewer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "QOpenGLFunctions"))
        return static_cast< QOpenGLFunctions*>(const_cast< OpenGLViewer*>(this));
